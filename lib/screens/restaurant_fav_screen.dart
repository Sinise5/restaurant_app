...
class RestoranFav extends StatefulWidget {
  const RestoranFav({super.key});

  @override
  State<RestoranFav> createState() => _RestoranFavState();
}

class _RestoranFavState extends State<RestoranFav> with WidgetsBindingObserver {
      ...
      child: TextField(
        ...
        onChanged: (query) {
          ...
          if (query.isEmpty) {
            ...
            provider.searchRestaurantsFavorite(query);
          }
        },
      ),
    );
